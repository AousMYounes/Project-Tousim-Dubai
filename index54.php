...
<head>
    ...
    <title>Travelers To, From And Via Dubai</title>
...
<section class="header">
    ...
    <section class="home2-about1">
         ...
         <div class="content2">
           <h3 style="color:#f2a713;">Travel to Dubai</h3>
           <h5>Before you book</h5>
           <p style="font-size: 14px;">All travelers to Dubai are no longer required to present a COVID‑19 vaccination certificate or undergo PCR tests. Travelers to or via Dubai are only required to comply with the transit and travel requirements of their final destination. Check if you need a visa(Opens an external website in a new tab)﻿. Depending on your nationality, you can obtain a visa on arrival, or you can apply for a visitor visa in advance (opens a page in the same tab) from the Dubai Immigration Department before you travel. Citizens of the GCC countries (Bahrain, Kuwait, Oman, Qatar and Saudi Arabia) are allowed to travel within the GCC countries and enter Dubai under the national ID card.</p>
           
           <br>
           <a  class="btn b55"  href="index3.php" role="button" >Book Now</a>
         </div>
     </section>
    <!-- //section -->
