    ...
    <!-- //end navbar -->
       ...
       <div class="picture3">
          <div class="pic-overlay3">
             ...
             <h1 class="heading">List of customers' names and their orders from restaurants</h1>
<table class="table">
        <thead>
          <tr>
            <th scope="col">ID</th>
        ...
        <?php
         ...
         try{
    $sql = "SELECT * FROM restaurants_form ORDER BY NameOrder,Date";   
