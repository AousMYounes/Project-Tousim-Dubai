...
<head>
    ...
    <title>ドバイへの旅行者、ドバイからの旅行者、ドバイ経由の旅行者</title>
...
<section class="header">
    ...
    <section class="home2-about1">
         ...
         <div class="content2">
           <h3 style="color:#f2a713;">ドバイへの旅行</h3>
           <h5>予約する前に</h5>
           <p style="font-size: 14px;">ドバイへのすべての旅行者は、COVID‑19ワクチン接種証明書の提示やPCR検査を受ける必要がなくなりました。ドバイへまたはドバイを経由する旅行者は、最終目的地の乗り継ぎおよび旅行要件に従うだけで済みます。ビザが必要かどうかを確認してください（新しいタブで外部のウェブサイトが開きます）﻿。国籍に応じて、到着時にビザを取得するか、旅行前にドバイ入国管理局に事前に訪問者ビザを申請することができます（同じタブでページが開きます）。GCC諸国（バーレーン、クウェート、オマーン、カタール、サウジアラビア）の国民は、国民IDカードを使用してGCC諸国内を旅行し、ドバイに入国することができます。</p>
           
           <br>
           <a  class="btn b55"  href="index3.php" role="button" >今予約する</a>
         </div>
     </section>
    <!-- //section -->
