...
<head>
    ...
    <title>두바이 도착, 출발 및 경유 여행자</title>
...
<section class="header">
    ...
    <section class="home2-about1">
         ...
         <div class="content2">
           <h3 style="color:#f2a713;">두바이 여행</h3>
           <h5>예약하기 전에</h5>
           <p style="font-size: 14px;">두바이를 방문하는 모든 여행자는 더 이상 코로나19 예방 접종 증명서를 제시하거나 PCR 검사를 받을 필요가 없습니다. 두바이를 오가는 여행자는 최종 목적지의 환승 및 여행 요건만 준수하면 됩니다. 비자가 필요한지 확인하세요(새 탭에서 외부 웹사이트 열림)﻿. 국적에 따라 도착 시 비자를 받거나 여행 전에 두바이 이민국에 미리 방문 비자를 신청할 수 있습니다(같은 탭에서 페이지 열림). GCC 국가(바레인, 쿠웨이트, 오만, 카타르, 사우디아라비아)의 시민은 국가 ID 카드로 GCC 국가 내에서 여행하고 두바이에 입국할 수 있습니다.</p>
           
           <br>
           <a  class="btn b55"  href="index105.php" role="button" >지금 예약</a>
         </div>
     </section>
    <!-- //section -->
