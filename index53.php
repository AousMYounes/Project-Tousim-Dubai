...
<head>
    ...
    <title>   المسافرون من دبي وإليها وعبرها</title>
...
<section class="home2-about1">
         ...
         <div class="content2">
           <h3 style="color:#f2a713;">السفر إلى دبي </h3>
           <h5>قبل أن تحجزوا</h5>
           <p style="font-size: 14px;">لم يعد يطلب من جميع المسافرين إلى دبي تقديم شهادة تطعيم ضد فيروس COVID‑19 أو إجراء اختبارات PCR. 

يطلب من المسافرين من دبي أو عبرها فقط الامتثال لمتطلبات العبور ومتطلبات السفر لوجهتهم النهائية.

تحققوا مما إذا كنتم بحاجة إلى تأشيرة(يفتح موقعاً شبكياً خارجياً في علامة تبويب جديدة)﻿. اعتماداً على جنسيتكم، يمكنكم الحصول على تأشيرة عند الوصول، أو يمكنكم التقدم بطلب للحصول على تأشيرة زيارة مسبقاً (يفتح صفحة في علامة التبويب نفسها) من دائرة الهجرة في دبي قبل سفركم.

يسمح لمواطني دول مجلس التعاون الخليجي (البحرين والكويت وعُمان وقطر والمملكة العربية السعودية) بالسفر داخل دول مجلس التعاون الخليجي ودخول دبي بموجب بطاقة الهوية الوطنية </p>
          
           <br>
           <a  class="btn b55"  href="index28.php" role="button" >احجز الأن</a>
         </div>
     </section>
    <!-- //section --> 
...
<div class="footer-overlay">
  <div class="box-container">
    ...
    <div class="credit">صمم من قبل <span>المهندس أوس محمد يونس</span> @2024 | كل الحقوق محفوظة! </div>
  </div>
</section>
<!-- //FOOTER -->
