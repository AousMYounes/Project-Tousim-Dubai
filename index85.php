...
<section class="header">
    ...
    <section class="home2-about1">
         ...
         <div class="content2">
           <h3 style="color:#f2a713;">前往迪拜</h3>
           <h5>预订前</h5>
           <p style="font-size: 14px;">所有前往迪拜的旅客不再需要出示新冠肺炎疫苗接种证明或接受 PCR 检测。前往或途经迪拜的旅客只需遵守最终目的地的过境和旅行要求即可。查看您是否需要签证（在新选项卡中打开外部网站）﻿。根据您的国籍，您可以在抵达时获得签证，也可以在旅行前提前向迪拜移民局申请访客签证（在同一选项卡中打开一个页面）。海湾合作委员会国家（巴林、科威特、阿曼、卡塔尔和沙特阿拉伯）的公民可以在海湾合作委员会国家内旅行，并凭国民身份证进入迪拜。</p>
           
           <br>
           <a  class="btn b55"  href="index3.php" role="button" >现在预订</a>
         </div>
     </section>
    <!-- //section -->
